...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dnc.mprs.propservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dnc.mprs.propservice.security.DomainUserDetailsService", "createSpringSecurityUser");
