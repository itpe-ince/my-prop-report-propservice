...
import { getEntities, searchEntities } from './transaction.reducer';
...
export const Transaction = () => {
  ...
  const transactionList = useAppSelector(state => state.propservice.transaction.entities);
  const loading = useAppSelector(state => state.propservice.transaction.loading);
  const totalItems = useAppSelector(state => state.propservice.transaction.totalItems);
  ...
  return (
    <div>
      <h2 id="transaction-heading" data-cy="TransactionHeading">
        <Translate contentKey="propserviceApp.propserviceTransaction.home.title">Transactions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="propserviceApp.propserviceTransaction.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
            to="/propservice/transaction/new"
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="propserviceApp.propserviceTransaction.home.createLabel">Create new Transaction</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('propserviceApp.propserviceTransaction.home.search')}
                />
        ...
        {transactionList && transactionList.length > 0 ? (
            ...
            <tbody>
              {transactionList.map((transaction, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/propservice/transaction/${transaction.id}`} color="link" size="sm">
                      {transaction.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        tag={Link}
                        to={`/propservice/transaction/${transaction.id}`}
                        color="info"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/propservice/transaction/${transaction.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/propservice/transaction/${transaction.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="propserviceApp.propserviceTransaction.home.notFound">No Transactions found</Translate>
            </div>
          )
        )}
      </div>
